...
class SupplierController extends Controller
{
    ...
    {
        $records = $request->query('invalid') ? MtSupplier::all() 
            : MtSupplier::whereNotNull(AppConst::VALID)->get();
    ...
    public function show($id)
    {
        ...
        $record = MtSupplier::where('personal_cd', '=', $id)
