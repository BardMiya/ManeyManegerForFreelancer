...
class ServicerController extends Controller
{
    ...
    {
        $records = $request->query('invalid') ? MtServicer::all() 
            : MtServicer::whereNotNull(AppConst::VALID)->get();
    ...
    public function show($id)
    {
        ...
        $record = MtServicer::where('personal_cd', '=', $id)
